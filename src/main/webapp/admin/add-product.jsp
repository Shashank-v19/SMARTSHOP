...
<main style="max-width: 900px; margin: 35px auto; padding: 0 24px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
        <div>
            <h1 style="font-size: 1.8rem; font-weight: 700; margin: 0 0 5px 0;">Add New Product</h1>
            <p style="color: #64748b; margin: 0;">Create a new item in your online store inventory</p>
        </div>
    ...
    <% if (success != null && !success.isBlank()) { %>
        <div style="background: #dcfce7; border: 1px solid #22c55e; color: #166534; padding: 12px 18px; border-radius: 8px; margin-bottom: 20px;">
            <%= success %>
        </div>
    <% } %>
        ...
        <form action="${pageContext.request.contextPath}/admin/add-product" method="post">
            ...
            <div class="form-grid-2">
                <div class="form-group">
                    ...
                    <input type="text" name="productName" placeholder="e.g. Wireless Noise-Canceling Headphones" required>
                </div>
                
                <div class="form-group">
                    <label>Brand / Manufacturer</label>
                    <input type="text" name="brand" placeholder="e.g. Sony, Apple, Nike">
                </div>
            </div>
            ...
            <div class="form-grid-2">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="stockQuantity" value="10" min="0" required>
                </div>
            </div>
            ...
            <div class="form-grid-2">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="price" placeholder="4999.00" required>
                </div>

                <div class="form-group">
                    <label>Discounted Price (₹)</label>
                    <input type="number" step="0.01" name="discountPrice" placeholder="3999.00 (optional)">
                </div>
            </div>

            <div class="form-group">
                <label>Image URL</label>
                <input type="url" name="imageUrl" placeholder="https://images.unsplash.com/photo-...">
                <small style="color: #64748b; font-size: 0.8rem;">Paste a direct image link or Unsplash image URL</small>
            </div>

            <div class="form-group">
                <label>Product Description</label>
                <textarea name="description" rows="4" placeholder="Detailed product specifications and features..."></textarea>
            </div>

            <div class="form-group" style="display: flex; align-items: center; gap: 10px; margin-top: 10px;">
                <input type="checkbox" name="active" id="activeCheck" value="true" checked style="width: auto; margin: 0;">
                <label for="activeCheck" style="margin: 0; cursor: pointer; font-weight: 500;">
                    Make this product active and visible in storefront immediately
                </label>
            </div>
